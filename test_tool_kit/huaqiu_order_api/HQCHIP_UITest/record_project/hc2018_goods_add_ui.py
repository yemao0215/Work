...
def run(playwright: Playwright, goods_name=None) -> None:
    ...
    page.locator('//div[@id="attrs-ext-1011"]//tbody/tr[1]/td[2]//input').click()
    ...
    page.locator('//div[@id="attrs-ext-1011"]//tbody/tr[1]/td[3]//input').click()
    page.locator('//div[@id="attrs-ext-1011"]//tbody/tr[1]/td[3]//input').fill("1000")
